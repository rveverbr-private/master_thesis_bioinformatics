...
scores, all_model_dict_per_generation, lineages = model_testing_genetic_algorithm(base_model, optimizer, "base_model", n_model_repeats=1, training_iterations=3000,
                          n_starting_population=10, algorithm_iterations=10, initialization_funcs=initialization_funcs, placeholder=placeholder, full_crossover=True, temporary_folder="temporary_safe1")

dir_path = "full_crossover"

# Create the directory
os.makedirs(dir_path, exist_ok=True)

with open("full_crossover/scores.pkl", "wb") as f:
    pickle.dump(scores, f)


with open("full_crossover/dictionary.pkl", "wb") as f:
    pickle.dump(all_model_dict_per_generation, f)    


with open("full_crossover/lineages.pkl", "wb") as f:
