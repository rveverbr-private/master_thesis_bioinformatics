...
scores, all_model_dict_per_generation, lineages = model_testing_elitism(base_model, optimizer, "base_model", n_model_repeats=1, training_iterations=3000,algorithm_iterations=10,initialization_funcs=initialization_funcs, placeholder=placeholder)
...
with open("elitism/scores.pkl", "wb") as f:
    pickle.dump(scores, f)


with open("elitism/dictionary.pkl", "wb") as f:
    pickle.dump(all_model_dict_per_generation, f)    


with open("elitism/lineages.pkl", "wb") as f:
